...
# Rutas dinámicas desde la ubicación del script
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.join(SCRIPT_DIR, "..", "..")
CARPETA_SALIDA = os.path.join(PROJECT_ROOT, "docs", "resultados")
...
if __name__ == "__main__":
    # A. Carga (ruta dinámica)
    archivo = os.path.join(PROJECT_ROOT, "data", "raw", "winemag-data-130k-v2.csv") 
